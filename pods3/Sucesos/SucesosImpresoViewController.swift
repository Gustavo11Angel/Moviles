...
@available(iOS 11.0, *)
class SucesosImpresoViewController: UIViewController, PDFViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        guard let path = Bundle.main.url(forResource: "Sucesos 15 ago", withExtension: "pdf") else {
    ...
    @objc func handlePageChange(){
        ...
        //Cambiamos el Título
        title = "Sucesos [\(pageTotalAndCurrentNumber)]"
