...
@available(iOS 11.0, *)
class VersionImpresaViewController: UIViewController, PDFViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        guard let path = Bundle.main.url(forResource: "NQro 15 ago", withExtension: "pdf") else {
    ...
    @objc func handlePageChange(){
        ...
        //Cambiamos el Título
        title = "Primera Sección [\(pageTotalAndCurrentNumber)]"
