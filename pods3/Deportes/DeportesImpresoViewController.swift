...
@available(iOS 11.0, *)
class DeportesImpresoViewController: UIViewController, PDFViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        guard let path = Bundle.main.url(forResource: "Deportes 15 ago", withExtension: "pdf") else {
    ...
    @objc func handlePageChange(){
        ...
        //Cambiamos el Título
        title = "Deportes [\(pageTotalAndCurrentNumber)]"
